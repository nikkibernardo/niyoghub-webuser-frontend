...
const Announcement = () => {
  ...
  return (
    <>
      <section id="announcement" className="flex flex-col items-center py-16 bg-white px-4 sm:px-8 md:px-10 lg:px-18">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl text-center mb-4 font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-[#EDCE3B] to-[#877522]">
        ...
        <p className="text-center text-gray-600 mb-6">
          ...
          <br />
          From vital industry updates to skill-enhancement initiatives, we are dedicated to nurturing your success.
        </p>

        {/* Carousel Container */}
        <div className="w-full max-w-[1000px] h-[350px] rounded-lg relative shadow-lg overflow-hidden bg-black bg-opacity-50">
          {/* Slide Image */}
          <img
